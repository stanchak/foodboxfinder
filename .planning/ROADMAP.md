...
- [ ] 15-05-PLAN.md -- Restyle FaqAccordion (rounded-xl container, hover:bg-gray-50), ReviewCard (py-8, neutral avatar), RatingBreakdown (h-2 bars, font-extrabold), AffiliateLink (rounded-xl, hover lift)
