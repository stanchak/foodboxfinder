export default function SearchLoading() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 animate-pulse">
      ...
      <div className="mt-4 h-12 w-full max-w-xl rounded-lg bg-gray-200" />

      {/* Results count skeleton */}
      <div className="mt-8 h-5 w-48 rounded bg-gray-200" />
      ...
      <div className="mt-10">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-6">
          {Array.from({ length: 2 }, (_, i) => (
            <div
              key={i}
              className="rounded-xl bg-white shadow-sm ring-1 ring-gray-100 p-5 space-y-3"
            >
