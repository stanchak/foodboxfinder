  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 animate-pulse">
      ...
      <div className="mt-8 flex flex-col md:flex-row gap-8">
        {/* Logo / hero image */}
        <div className="w-full md:w-72 h-48 md:h-56 rounded-xl bg-neutral-200 shrink-0" />
        ...
        <div className="flex-1 space-y-4">
          ...
          {/* Name */}
          <div className="h-10 w-72 max-w-full rounded bg-neutral-200" />
          {/* Rating + reviews */}
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
        {Array.from({ length: 2 }, (_, i) => (
          <div key={i} className="rounded-xl bg-white ring-1 ring-neutral-100 p-6 space-y-3">
            <div className="h-6 w-16 rounded bg-neutral-200" />
            {Array.from({ length: 3 }, (_, j) => (
              <div key={j} className="flex items-start gap-2">
                <div className="h-5 w-5 rounded-full bg-neutral-200 shrink-0 mt-0.5" />
                <div className="h-4 w-full rounded bg-neutral-200" />
              </div>
            ))}
          </div>
      ...
      <div className="mt-10">
        ...
        <div className="mt-4 space-y-3">
          {Array.from({ length: 3 }, (_, i) => (
            <div
              key={i}
              className="h-20 w-full rounded-lg bg-neutral-100"
            />
          ))}
        </div>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="mt-4 space-y-4">
          {Array.from({ length: 3 }, (_, i) => (
            <div
              key={i}
              className="rounded-lg bg-white ring-1 ring-neutral-100 p-5 space-y-3"
            >
              <div className="flex items-center gap-3">
                <div className="h-5 w-28 rounded bg-neutral-200" />
                <div className="h-5 w-20 rounded bg-neutral-200" />
