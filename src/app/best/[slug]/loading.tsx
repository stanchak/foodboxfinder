    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 animate-pulse">
      ...
      <div className="mt-6 space-y-6">
        {Array.from({ length: 3 }, (_, i) => (
          <div
            key={i}
            className="flex flex-col sm:flex-row rounded-xl bg-white shadow-card ring-1 ring-gray-100 overflow-hidden"
          >
            <div className="h-36 sm:h-auto sm:w-32 bg-gray-100 shrink-0" />
