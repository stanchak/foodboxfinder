export default function VersusLoading() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 animate-pulse">
      ...
      <div className="mt-6">
        <div className="h-10 w-96 max-w-full rounded bg-neutral-200" />
        <div className="mt-3 h-5 w-full max-w-3xl rounded bg-neutral-200" />
        <div className="mt-2 h-5 w-4/5 max-w-3xl rounded bg-neutral-200" />
      </div>
      ...
      <div className="mt-12">
        ...
        <div className="mt-4 rounded-xl border border-neutral-200 bg-neutral-50/50 p-6 space-y-4">
      ...
      <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
        <div className="h-12 w-36 rounded-lg bg-neutral-200" />
        <div className="h-12 w-36 rounded-lg bg-neutral-200" />
