  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 animate-pulse">
      ...
      <div className="mt-10 text-center">
        <div className="mx-auto h-20 w-20 rounded-full bg-neutral-200" />
        <div className="mx-auto mt-4 h-10 w-80 max-w-full rounded bg-neutral-200" />
        <div className="mx-auto mt-3 h-5 w-96 max-w-full rounded bg-neutral-200" />
        <div className="mx-auto mt-2 h-5 w-72 max-w-full rounded bg-neutral-200" />
      </div>
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-3 max-w-3xl mx-auto">
        {Array.from({ length: 3 }, (_, i) => (
          <div key={i} className="text-center">
            <div className="mx-auto h-10 w-10 rounded-full bg-neutral-200" />
            <div className="mx-auto mt-3 h-4 w-28 rounded bg-neutral-200" />
            <div className="mx-auto mt-2 h-3 w-36 rounded bg-neutral-200" />
            <div className="mx-auto mt-1 h-3 w-32 rounded bg-neutral-200" />
          </div>
        ))}
      </div>
      ...
      <div className="mt-14 text-center">
        <div className="mx-auto h-7 w-64 rounded bg-neutral-200" />
        <div className="mx-auto mt-2 h-5 w-56 rounded bg-neutral-200" />
      </div>
