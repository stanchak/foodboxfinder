  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 animate-pulse">
      ...
      <div className="mt-6 text-center">
        <div className="mx-auto h-10 w-48 max-w-full rounded bg-neutral-200" />
        <div className="mx-auto mt-3 h-5 w-80 max-w-full rounded bg-neutral-200" />
      </div>

      {/* Featured post skeleton */}
      <div className="mt-10 overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-neutral-100">
        <div className="flex flex-col lg:flex-row">
          <div className="h-64 lg:h-80 lg:w-1/2 bg-neutral-100 shrink-0" />
          <div className="flex flex-1 flex-col justify-center p-6 lg:p-10 space-y-4">
            ...
            <div className="h-8 w-80 max-w-full rounded bg-neutral-200" />
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }, (_, i) => (
          ...
          >
            <div className="h-48 bg-neutral-100 shrink-0" />
